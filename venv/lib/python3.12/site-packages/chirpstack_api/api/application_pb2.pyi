...
class IntegrationKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    BLYNK: _ClassVar[IntegrationKind]
...
class InfluxDbVersion(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INFLUXDB_3: _ClassVar[InfluxDbVersion]
JSON: Encoding
PROTOBUF: Encoding
...
class BlynkIntegration(_message.Message):
    __slots__ = ("application_id", "token")
    APPLICATION_ID_FIELD_NUMBER: _ClassVar[int]
    TOKEN_FIELD_NUMBER: _ClassVar[int]
    application_id: str
    token: str
    def __init__(self, application_id: _Optional[str] = ..., token: _Optional[str] = ...) -> None: ...

class CreateBlynkIntegrationRequest(_message.Message):
    __slots__ = ("integration",)
    INTEGRATION_FIELD_NUMBER: _ClassVar[int]
    integration: BlynkIntegration
    def __init__(self, integration: _Optional[_Union[BlynkIntegration, _Mapping]] = ...) -> None: ...

class GetBlynkIntegrationRequest(_message.Message):
    __slots__ = ("application_id",)
    APPLICATION_ID_FIELD_NUMBER: _ClassVar[int]
    application_id: str
    def __init__(self, application_id: _Optional[str] = ...) -> None: ...

class GetBlynkIntegrationResponse(_message.Message):
    __slots__ = ("integration",)
    INTEGRATION_FIELD_NUMBER: _ClassVar[int]
    integration: BlynkIntegration
    def __init__(self, integration: _Optional[_Union[BlynkIntegration, _Mapping]] = ...) -> None: ...

class UpdateBlynkIntegrationRequest(_message.Message):
    __slots__ = ("integration",)
    INTEGRATION_FIELD_NUMBER: _ClassVar[int]
    integration: BlynkIntegration
    def __init__(self, integration: _Optional[_Union[BlynkIntegration, _Mapping]] = ...) -> None: ...

class DeleteBlynkIntegrationRequest(_message.Message):
    __slots__ = ("application_id",)
    APPLICATION_ID_FIELD_NUMBER: _ClassVar[int]
    application_id: str
    def __init__(self, application_id: _Optional[str] = ...) -> None: ...
