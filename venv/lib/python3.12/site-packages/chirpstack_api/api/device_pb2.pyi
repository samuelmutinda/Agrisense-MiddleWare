...
class EnqueueDeviceQueueItemRequest(_message.Message):
    __slots__ = ("queue_item", "flush_queue")
    QUEUE_ITEM_FIELD_NUMBER: _ClassVar[int]
    FLUSH_QUEUE_FIELD_NUMBER: _ClassVar[int]
    queue_item: DeviceQueueItem
    flush_queue: bool
    def __init__(self, queue_item: _Optional[_Union[DeviceQueueItem, _Mapping]] = ..., flush_queue: bool = ...) -> None: ...
